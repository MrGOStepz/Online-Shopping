...
if(isset($_POST["submit"])){
  ...
  $query = "SELECT * FROM user WHERE email='$newemail' AND id<>'$id'";
  ...
  if(count($errors)==0){
    ...
    elseif($newemail!="" && $newpassword!=""){
      $newpassword = password_hash($newpassword,PASSWORD_DEFAULT);
      $query = "UPDATE user SET email='$newemail',password='$newpassword' WHERE id='$id'";
        ...
        foreach($wisharray as $wish){
          ...
          echo "<div class=\"col-md-4\">
                  ...
                  <a href='detail.php?id=$productid'>
                    <img class='img-responsive product-image' src='images/$arimage[0]'>
                  </a>
